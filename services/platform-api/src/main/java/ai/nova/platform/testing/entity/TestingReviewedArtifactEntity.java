...
@Entity
@Table(name = "testing_reviewed_artifacts")
public class TestingReviewedArtifactEntity {
    ...
    protected TestingReviewedArtifactEntity() {
    }

    public TestingReviewedArtifactEntity(
            UUID id,
