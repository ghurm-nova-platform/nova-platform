...
- Enterprise Identity — unified auth entry wrapping JWT; SAML/OIDC/LDAP providers, sessions, login history, MFA (TOTP/WebAuthn), optional SCIM read, password policies (V58)
