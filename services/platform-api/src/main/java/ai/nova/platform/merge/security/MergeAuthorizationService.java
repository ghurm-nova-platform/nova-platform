package ai.nova.platform.merge.security;
...
@Service
public class MergeAuthorizationService {

    public static final String MERGE_RUN = "MERGE_RUN";
    public static final String MERGE_READ = "MERGE_READ";
