...
class ModelGatewayExecutionIntegrationTest {
    ...
    @Test
    void executeReturnsModelMetadataViaGateway() throws Exception {
        mockMvc.perform(post("/api/projects/" + PROJECT_ID + "/agents/" + DEMO_AGENT_ID + "/execute")
                        .header("Authorization", "Bearer " + accessToken)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("""
                                {
                                  "input":{"message":"hello gateway"},
                ...
                .andExpect(jsonPath("$.model.attemptCount").value(1));
    }
}
